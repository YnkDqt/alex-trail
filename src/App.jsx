  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
            ...
            {race.aidStations.map((as, idx) => (
              <div key={idx} style={{ 
                ...
                padding: "8px 12px", 
                borderRadius: "8px",
                flexWrap: "wrap" // MODIFICATION : Permet au contenu de passer à la ligne
              }}>
                <div style={{ 
                  fontWeight: "700", 
                  color: "var(--primary-deep)", 
                  flex: "1", 
                  minWidth: "120px", // Assure une largeur mini avant de wrapper
                  wordBreak: "break-word" // MODIFICATION : Coupe le texte proprement s'il est trop long
                }}>{as.name}</div>
                <div style={{ fontSize: "0.85rem", background: "var(--white)", padding: "2px 8px", borderRadius: "4px", whiteSpace: "nowrap" }}>km {as.km}</div>
      ...
      <Card>
        ...
        {/* MODIFICATION : Conteneur scrollable pour les segments */}
        <div style={{ 
          maxHeight: "480px", // Limite à environ 7-8 segments
          overflowY: "auto", 
          paddingRight: "10px",
